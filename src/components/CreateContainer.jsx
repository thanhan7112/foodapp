    ...
    <div className='w-full min-h-screen flex items-center justify-center'>
      <div className='w-[90%] md:w-[75%] border border-gray-200 rounded-lg p-4 flex flex-col items-center justify-center gap-4'>
        ...
        <div className='w-full py-2 border-b border-gray-300 flex items-center gap-2'>
          ...
          <input type='text' onChange={(e) => setTitle(e.target.value)} required value={title} placeholder='Give me a title'
        ...
        <div className='group flex justify-center items-center flex-col border-2 border-dotted border-gray-300 w-full h-225 md:h-420 cursor-pointer rounded-lg'>
          {isLoading ? <Loader /> : <>
            {!imageAsset ? <>
              ...
              <button type='button' className='absolute bottom-3 right-3 p-3 rounded-full bg-red-500 text-xl cursor-pointer outline-none hover:shadow-md duration-500 transition-all ease-out' onClick={deleteImage}>
